...
// В реальности нужно добавлять Zustand или другой стейт менеджер для сохранения и управления стейтом,
// Нужно использовать глобальный стор для хранения токена пользователя и его данных для нормальной работы при перезагрузке приложения.
// Также данные по таскам нужно сохранять в глобальном сторе,
//  а не в асинк сторадже + делать API запросы к бд, чтобы хранить эти данные в базе.
// Также нужно использовать Zod для валидации данных перед хождением в бд.

// Короче вы хотели базовую версию, вот она :)
// Все остальное буду рад обсудить на собеседовании.
